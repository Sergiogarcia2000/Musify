        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-3">
                <form class="form-container" action="${pageContext.request.contextPath}/Register" method="POST">
                    ...
                    <div class="form-group">
                        <label for="confirm_password_input">Confirmar contrase̱a</label>
                        <input type="password" class="form-control" name="confirm_password_input">
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="remember_checkbox">
                        <label class="form-check-label" for="remember_checkbox">Acepto los <a href="./terms.html">t̩rminos y condiciones</a>.</label>
                    </div>
