...
<body class="alert-dark bg">
    ...
    <% 
            Boolean b = (Boolean) request.getSession().getAttribute("registered");
            Boolean email = (Boolean) request.getSession().getAttribute("emailinuse");

            if (email != null){
                if (email){
                    %> 
                    <script>window.alert("¡El email introducido ya está en uso!");</script>
                    <%
                }
            }
            ...
            if (b != null){
                if (!b){
                    %> 
                    <script>window.alert("Las contraseñas no coinciden");</script>
                    <%
                }
            }
        %>
